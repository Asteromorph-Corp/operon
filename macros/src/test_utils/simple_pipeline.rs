//! The `test_utils::simple_pipeline` module provides fixtures for a simple pipeline configuration.
//!
...
use crate::{AllConfig, DimensionConfig, EntityConfig, JobArg, JobConfig, JobConfigMap};
