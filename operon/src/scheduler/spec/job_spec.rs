    ...
    MSto: MetaBackend,
{
    ...
    async fn check_consistency(
        ...
        mode: CheckMode,
    ) -> Result<bool, SchedulerError<MSto::Error, Sto::Error>>;
    ...
    async fn prepare_rebuild(
        ...
        client: MSto::Client<'_>,
    ) -> Result<Box<dyn JobRebuilder<Sto, MSto>>, SchedulerError<MSto::Error, Sto::Error>>;
    ...
    async fn run_job(
        ...
        meta: MSto,
        job: Self::Job,
    ) -> Result<Self::Resolution, SchedulerError<MSto::Error, Sto::Error>>;
    ...
    async fn on_receive_job(
        ...
        client: MSto::Client<'_>,
        job: Svc::JobEnum,
    ) -> Result<Vec<Self::Ticket>, SchedulerError<MSto::Error, Sto::Error>>;
