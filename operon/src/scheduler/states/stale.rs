    ...
    MSto: MetaBackend,
{
    ...
    fn into_clean(self) -> TransitionState<SchedulerError<MSto::Error, Sto::Error, Svc::Error>> {
    ...
    fn into_restore(self) -> TransitionState<SchedulerError<MSto::Error, Sto::Error, Svc::Error>> {
